...
namespace VIDO_SLAM
{
    ...
    void Optimizer::PartialBatchOptimization(Map *pMap, const cv::Mat Calib_K, const int WINDOW_SIZE)
    {
        ...
        // start optimize
        std::cout << "Number of vertices1: " << optimizer.vertices().size() << std::endl;
        std::cout << "Number of edges1: " << optimizer.edges().size() << std::endl;
        ...
        if (check_after_opt)
        {
            // ****** check the chi2 error stats ******
            cout << endl
                 << "(" << vpEdgeSE3.size() << ") " << "EdgeSE3 chi2: " << endl;
            for (size_t i = 0, iend = vpEdgeSE3.size(); i < iend; i++)
            {
                g2o::EdgeSE3 *e = vpEdgeSE3[i];
                const float chi2 = e->chi2();
    ...
    void Optimizer::FullBatchOptimization(Map *pMap, const cv::Mat Calib_K)
    {
        ...
        // start optimize
        std::cout << "Number of vertices2: " << optimizer.vertices().size() << std::endl;
        std::cout << "Number of edges2: " << optimizer.edges().size() << std::endl;
        optimizer.initializeOptimization();
        optimizer.setVerbose(true);
    ...
    int Optimizer::PoseOptimizationNew(Frame *pCurFrame, Frame *pLastFrame, vector<int> &TemperalMatch)
    {
        ...
        for (size_t it = 0; it < 1; it++)
        {
            ...
            vSE3->setEstimate(Converter::toSE3Quat(pCurFrame->mTcw));
            std::cout << "Number of vertices3: " << optimizer.vertices().size() << std::endl;
            std::cout << "Number of edges3: " << optimizer.edges().size() << std::endl;
    ...
    void Optimizer::InertialOptimization(Map *pMap, Eigen::Matrix3d &Rwg, double &scale)
    {
        ...
        std::cout << "Number of vertices4: " << optimizer.vertices().size() << std::endl;
        std::cout << "Number of edges4: " << optimizer.edges().size() << std::endl;
        optimizer.initializeOptimization();
    ...
    void Optimizer::InertialOptimization(Map *pMap, Eigen::Matrix3d &Rwg, double &scale, Eigen::Vector3d &bg, Eigen::Vector3d &ba, bool bFixedVel, float priorG, float priorA)
    {
        ...
        optimizer.setVerbose(true);
        std::cout << "Number of vertices5: " << optimizer.vertices().size() << std::endl;
        std::cout << "Number of edges5: " << optimizer.edges().size() << std::endl;
        optimizer.initializeOptimization();
        optimizer.optimize(its);
    ...
    int Optimizer::PoseOptimizationFlow2Cam(Frame *pCurFrame, Frame *pLastFrame, vector<int> &TemperalMatch)
    {
        ...
        for (size_t it = 0; it < 4; it++)
        {
            ...
            vSE3->setEstimate(Converter::toSE3Quat(Init));
            std::cout << "Number of vertices6: " << optimizer.vertices().size() << std::endl;
            std::cout << "Number of edges6: " << optimizer.edges().size() << std::endl;
            optimizer.initializeOptimization(0);
            optimizer.optimize(its[it]);
    ...
    cv::Mat Optimizer::PoseOptimizationObjMot(Frame *pCurFrame, Frame *pLastFrame, const vector<int> &ObjId, std::vector<int> &InlierID)
    {
        ...
        for (size_t it = 0; it < 1; it++)
        {
            ...
            vSE3->setEstimate(Converter::toSE3Quat(Init));
            std::cout << "Number of vertices7: " << optimizer.vertices().size() << std::endl;
            std::cout << "Number of edges7: " << optimizer.edges().size() << std::endl;
            optimizer.initializeOptimization(0);
            optimizer.optimize(its[it]);
    ...
    cv::Mat Optimizer::PoseOptimizationFlow2(Frame *pCurFrame, Frame *pLastFrame, const vector<int> &ObjId, std::vector<int> &InlierID)
    {
        ...
        for (size_t it = 0; it < 1; it++)
        {
            ...
            vSE3->setEstimate(Converter::toSE3Quat(Init));
            std::cout << "Number of vertices8: " << optimizer.vertices().size() << std::endl;
            std::cout << "Number of edges8: " << optimizer.edges().size() << std::endl;
            optimizer.initializeOptimization(0);
            optimizer.optimize(its[it]);
